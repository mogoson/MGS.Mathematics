...
{
    public class IntersectionSample : MonoBehaviour
    {
        ...
        void Update()
        {
            if (Input.GetKeyDown(KeyCode.I))
            {
                ...
                var c0 = new Circle(new Vector2(circle0.position.x, circle0.position.y), circle0.localScale.z * 0.5f);
                var c1 = new Circle(new Vector2(circle1.position.x, circle1.position.y), circle1.localScale.z * 0.5f);
                ...
                var p0 = new Vector2(line.position.x, line.position.y);
                var p1 = new Vector2(offset.x, offset.y);
